...
(function() {
  angular.module('fullpageApp').directive('spy', function($location) {
    return {
      restrict: "A",
      require: "^scrollSpy",
  ...
  angular.module('fullpageApp').directive('scrollSpy', function($window) {
    return {
      restrict: 'A',
...
/*
//@ sourceMappingURL=scrollspy.map
*/
